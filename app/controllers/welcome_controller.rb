class WelcomeController < ApplicationController
  #try to access the open weather api try to get some info back
  def test
    @response = HTTParty.get("http://api.openweathermap.org/data/2.5/weather?zip=11207&units=imperial&appid=#{ENV['openweather_api_key']}")
